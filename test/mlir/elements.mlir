...
func.func @test_1d(%a: tensor<f32>, %b: tensor<f32>, %c: tensor<f32>) -> tensor<3xf32> {
  %0 = colgm.elements(%a, %b, %c) {target_shape = [3]} : tensor<f32> -> tensor<3xf32>
  return %0 : tensor<3xf32>
}

func.func @test_2d(%a: tensor<f64>, %b: tensor<f64>, %c: tensor<f64>, %d: tensor<f64>) -> tensor<2x2xf64> {
